...
class ParserModel(nn.Module):
    ...
    def forward(self, w):
        ...
        linear = self.embedding_lookup(w) @ self.embed_to_hidden_weight + self.embed_to_hidden_bias
        relu_out = nn.functional.relu(linear)
        dropout_layer = self.dropout(relu_out)
        logits = dropout_layer @ self.hidden_to_logits_weight + self.hidden_to_logits_bias
